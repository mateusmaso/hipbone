...
},{"./hipbone/application":2,"./hipbone/collection":13,"./hipbone/history":22,"./hipbone/i18n":24,"./hipbone/identity_map":25,"./hipbone/model":26,"./hipbone/module":35,"./hipbone/route":36,"./hipbone/router":43,"./hipbone/storage":47,"./hipbone/view":48}],2:[function(require,module,exports){
(function() {
...
},{"./application/ajax":3,"./application/initializers":4,"./application/locale":11,"./application/state":12,"./module":35,"./router":43,"./storage":47}],3:[function(require,module,exports){
(function() {
  var slice = [].slice;
...
},{"./collection/filters":14,"./collection/meta":15,"./collection/pagination":16,"./collection/parent":17,"./collection/polymorphic":18,"./collection/populate":19,"./collection/store":20,"./collection/sync":21,"./model":26,"./module":35}],14:[function(require,module,exports){
(function() {
  module.exports = {
...
},{"./history/query":23,"./module":35}],23:[function(require,module,exports){
(function() {
  module.exports = {
...
},{"./module":35}],25:[function(require,module,exports){
(function() {
...
},{"./module":35}],26:[function(require,module,exports){
(function() {
  var Model, Module,
    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty;
...
},{"./model/computed_attributes":27,"./model/mappings":28,"./model/nested_attributes":29,"./model/populate":30,"./model/schemes":31,"./model/store":32,"./model/syncs":33,"./model/validations":34,"./module":35}],27:[function(require,module,exports){
(function() {
  module.exports = {
...
},{"./module":35,"./route/activate":37,"./route/element":38,"./route/parameters":39,"./route/populate":40,"./route/store":41,"./route/title":42}],37:[function(require,module,exports){
(function() {
  module.exports = {
    active: function() {},
...
},{"./../model":26}],40:[function(require,module,exports){
(function() {
  module.exports = {
    initializePopulate: function() {
      return this.deferreds = {};
...
},{"./../identity_map":25}],42:[function(require,module,exports){
(function() {
  module.exports = {
...
},{"./history":22,"./module":35,"./router/matches":44,"./router/params":45,"./router/url":46}],44:[function(require,module,exports){
(function() {
  module.exports = {
...
},{"./module":35}],48:[function(require,module,exports){
(function() {
  var Module, View,
    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty;
...
},{"./module":35,"./view/bubble":49,"./view/class_name_bindings":50,"./view/content":51,"./view/context":52,"./view/elements":53,"./view/lifecycle":54,"./view/populate":55,"./view/properties":56,"./view/template":57}],49:[function(require,module,exports){
(function() {
  var slice = [].slice;
